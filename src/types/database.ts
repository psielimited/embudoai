...
export interface MerchantSettings {
  ...
  creds_status: 'unknown' | 'pass' | 'fail' | 'blocked_sandbox';
  creds_error: string | null;
  creds_checked_at: string | null;
  webhook_verify_status: 'unknown' | 'pass' | 'fail' | 'blocked_sandbox';
  webhook_verify_error: string | null;
  webhook_verified_at: string | null;
  last_inbound_at: string | null;
  last_inbound_event_id: string | null;
  inbound_status: 'unknown' | 'pass' | 'fail' | 'blocked_sandbox';
  ...
  outbound_status: 'unknown' | 'pass' | 'fail' | 'blocked_sandbox';
